...
awkDmg_ELX = Elixir('AWK_SKILL_DMG', GearType.Shoulder,
                    {Stats.AwkDmg: {1: 0.012, 2: 0.0247, 3: 0.0375, 4: 0.0562, 5: 0.075}})
bossDmg_ELX = Elixir('BOSS_DMG', GearType.Shoulder,
                     {Stats.MultDmg: {1: 0.012, 2: 0.0247, 3: 0.0375, 4: 0.0562, 5: 0.075}})
...
idenGain_ELX = Elixir('SPECIALTY_GAIN', GearType.Pants,
                      {Stats.IdentityGain: {1: 0.0064, 2: 0.0132, 3: 0.02, 4: 0.03, 5: 0.04}})
apBuff_ELX = Elixir('ALLY_ENHANCE', GearType.Pants, {Stats.APBuff: {1: 0.0096, 2: 0.0198, 3: 0.03, 4: 0.045, 5: 0.06}})
helmet_DPS_ELX = Elixir('HELMET_COMMON', GearType.Helmet,
                        {Stats.MultDmg: {1: 0.0049, 2: 0.0102, 3: 0.0155, 4: 0.0232, 5: 0.031}})
gloves_DPS_ELX = Elixir('HELMET_COMMON', GearType.Gloves,
                        {Stats.AtkPower: {1: 0.0023, 2: 0.0047, 3: 0.0072, 4: 0.0108, 5: 0.0144}})
helmet_SUP_ELX = Elixir('HELMET_COMMON', GearType.Helmet,
                        {Stats.HealShield: {1: 0.0023, 2: 0.0047, 3: 0.0072, 4: 0.00108, 5: 0.0144}})
gloves_SUP_ELX = Elixir('HELMET_COMMON', GearType.Gloves,
                        {Stats.APBuff: {1: 0.0064, 2: 0.0132, 3: 0.02, 4: 0.03, 5: 0.04}})
...
BLADED_SHIELD = Elixir('MASTER', None, {Stats.MultDmg: {1: 0.04, 2: 0.12}})
VANGUARD = Elixir('VANGUARD', None, {Stats.SkillDmg: {1: 0.03, 2: 0.03}, Stats.AtkPower: {1: 0.03, 2: 0.03},
                                     Stats.MultDmg: {1: 0, 2: 0.05}})
FAITH = Elixir('FAITH', None, {Stats.APBuff: {1: 0.08, 2: 0.14}, Stats.IdentityGain: {1: 0, 2: 0.05}})
LUMINARY = Elixir('LUMINARY', None, {Stats.APBuff: {1: 0.08, 2: 0.14}, Stats.SkillCDR: {1: 0, 2: 0.05}})
ADVANCE = Elixir('ADVANCE', None,
